...
bool Situation_8::Initialize()
{
	hbit[0] = (HBITMAP)LoadImage(NULL, L"./Bitmap/sit_8/BackGround.bmp", IMAGE_BITMAP, 0, 0,
		LR_LOADFROMFILE | LR_CREATEDIBSECTION);
	hbit[1] = (HBITMAP)LoadImage(NULL, L"./Bitmap/sit_8/Narr1.bmp", IMAGE_BITMAP, 0, 0,
		LR_LOADFROMFILE | LR_CREATEDIBSECTION);
	hbit[2] = (HBITMAP)LoadImage(NULL, L"./Bitmap/sit_8/Narr2.bmp", IMAGE_BITMAP, 0, 0,
		LR_LOADFROMFILE | LR_CREATEDIBSECTION);
	hbit[3] = (HBITMAP)LoadImage(NULL, L"./Bitmap/sit_8/ButtonA.bmp", IMAGE_BITMAP, 0, 0,
		LR_LOADFROMFILE | LR_CREATEDIBSECTION);
	hbit[4] = (HBITMAP)LoadImage(NULL, L"./Bitmap/sit_8/ButtonB.bmp", IMAGE_BITMAP, 0, 0,
		LR_LOADFROMFILE | LR_CREATEDIBSECTION);
	hbit[5] = (HBITMAP)LoadImage(NULL, L"./Bitmap/sit_8/ButtonC.bmp", IMAGE_BITMAP, 0, 0,
		LR_LOADFROMFILE | LR_CREATEDIBSECTION);
	hbit[6] = (HBITMAP)LoadImage(NULL, L"./Bitmap/sit_8/BackGround_A.bmp", IMAGE_BITMAP, 0, 0,
		LR_LOADFROMFILE | LR_CREATEDIBSECTION);
	hbit[7] = (HBITMAP)LoadImage(NULL, L"./Bitmap/sit_8/BackGround_B.bmp", IMAGE_BITMAP, 0, 0,
		LR_LOADFROMFILE | LR_CREATEDIBSECTION);
	hbit[8] = (HBITMAP)LoadImage(NULL, L"./Bitmap/sit_8/BackGround_C.bmp", IMAGE_BITMAP, 0, 0,
		LR_LOADFROMFILE | LR_CREATEDIBSECTION);
	hbit[9] = (HBITMAP)LoadImage(NULL, L"./Bitmap/sit_8/NarrA_1.bmp", IMAGE_BITMAP, 0, 0,
		LR_LOADFROMFILE | LR_CREATEDIBSECTION);
	hbit[10] = (HBITMAP)LoadImage(NULL, L"./Bitmap/sit_8/NarrA_2.bmp", IMAGE_BITMAP, 0, 0,
		LR_LOADFROMFILE | LR_CREATEDIBSECTION);
	hbit[11] = (HBITMAP)LoadImage(NULL, L"./Bitmap/sit_8/NarrB_1.bmp", IMAGE_BITMAP, 0, 0,
		LR_LOADFROMFILE | LR_CREATEDIBSECTION);
	hbit[12] = (HBITMAP)LoadImage(NULL, L"./Bitmap/sit_8/NarrB_2.bmp", IMAGE_BITMAP, 0, 0,
		LR_LOADFROMFILE | LR_CREATEDIBSECTION);
	hbit[13] = (HBITMAP)LoadImage(NULL, L"./Bitmap/sit_8/NarrC_1.bmp", IMAGE_BITMAP, 0, 0,
		LR_LOADFROMFILE | LR_CREATEDIBSECTION);
	hbit[14] = (HBITMAP)LoadImage(NULL, L"./Bitmap/sit_8/NarrC_2.bmp", IMAGE_BITMAP, 0, 0,
		LR_LOADFROMFILE | LR_CREATEDIBSECTION);
...
void Situation_8::UnInitialize()
{
	delete[]hbit;
	//delete[]Button;
}

void Situation_8::InputProcess()
{
	...
	if (InputManager()->KeyDown(VK_RETURN))	// 엔터
	{
		...
		else if (SitState == Sit_A_1)
		{
			SitState = Sit_A_2;
		}
		else if (SitState == Sit_B_1)
		{
			SitState = Sit_B_2;
		}
		else if (SitState == Sit_C_1)
		{
			SitState = Sit_C_2;
		}
		///////////////////////////////////////////////////
...
void Situation_8::Process()
{


}

void Situation_8::Render(HDC hDC)
{
